...
$(function () {    
    (function ($) {
        $.fn.jalendar = function (options) {
            ...
            // function head(){
            //     // $(".header").css({"background-image":"url(./images/冬天.jpg)"});
            //     alert($("h1").html())
            // }
            // head()

            // 根据年份判断生肖
            function getAnimal(years){
                if(years<0){
                    alert('信息有误')
                    return false;
                }
            ...
            function mine(){
                for(var i=1900;i<2100;i++){
                    // alert(i)
                    function one(animals){
                        if(getAnimal(i)==animals){
                            if($('h1').text()=='January '+i || $('h1').text()=='November '+i || $('h1').text()=='December '+i){
                                // alert($('h1').text())
                                $("body").css({"background-image":"url(./images/冬天.jpg)"});
                                $(".header").css({"background-image":"url(./images/冬天.jpg)"});
                                $(".jalendar-wood ").css({"background-image":"url(./images/"+animals+".jpg)"});

                            }else if($('h1').text()=='February '+i || $('h1').text()=='March '+i || $('h1').text()=='April '+i){

                                $("body").css({"background-image":"url(./images/春天.jpg)"});
                                $(".header").css({"background-image":"url(./images/春天.jpg)"});
                                $(".jalendar-wood ").css({"background-image":"url(./images/"+animals+".jpg)"});

                            }else if($('h1').text()=='May '+i || $('h1').text()=='June '+i || $('h1').text()=='July '+i){

                                $("body").css({"background-image":"url(./images/夏天.jpg)"});
                                $(".header").css({"background-image":"url(./images/夏天.jpg)"});
                                $(".jalendar-wood ").css({"background-image":"url(./images/"+animals+".jpg)"});

                            }else if($('h1').text()=='August '+i || $('h1').text()=='September '+i || $('h1').text()=='October '+i){

                                $("body").css({"background-image":"url(./images/秋天.jpg)"});
                                $(".header").css({"background-image":"url(./images/秋天.jpg)"});
                                $(".jalendar-wood ").css({"background-image":"url(./images/"+animals+".jpg)"});
                            }
                        }
